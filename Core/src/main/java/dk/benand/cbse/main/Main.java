...
import dk.benand.cbse.common.background.Background;
...
public class Main extends Application {
    ...
    private Collection<? extends BackgroundSPI> getBackgroundService() {
        return ServiceLoader.load(layer, BackgroundSPI.class).stream().map(ServiceLoader.Provider::get).collect(toList());
    }
}
